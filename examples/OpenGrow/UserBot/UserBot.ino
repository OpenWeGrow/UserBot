...
this example covers the sampling of both digital(Button) and analog(LM35) devices,
while also showing how to act on an output and set its desirable "speed/intensity" using the PWM pins of Arduino.
